...
class TestTrainee(unittest.TestCase):
    def setUp(self):
        self.t1 = trainee('1', 'Alice', 'Python', 'Bachelor', '1 year')
        self.t2 = trainee('2', 'Bob', 'Java', 'Master', '2 years')
        self.t3 = trainee('3', 'Charlie', 'C++', 'PhD', '3 years')
    ...
    def test_save_to_excel(self):
        ...
        wb = openpyxl.load_workbook('TESTMasterRecord.xlsx')
        ws = wb['ListOfTrainees']
        self.assertEqual(ws.cell(row=2, column=1).value, '1')
        self.assertEqual(ws.cell(row=2, column=2).value, 'Alice')
        ...
        self.assertEqual(ws.cell(row=4, column=2).value, 'Charlie')
